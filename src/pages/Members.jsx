...
export default function Members() {
  ...
  const { members, saveMember, removeMember } = useMembers();
  ...
  function handleDelete(memberId) {
    ...
    if (member) {
      removeMember(member.id, member.workspaceId, member.name);
    }
  }
  ...
  return (
    <div className="px-8 py-8">
      ...
      />
      <MembersGrid members={filtered} onEdit={handleEditClick} onDelete={handleDelete} />
